...
const Comment = (props) => {
    ...
    const handeSubmitComment = (e) => {
        ...
        // console.log(data);
        axios.post("https://api-movie-group-8.up.railway.app/api/comment/add", data).then((res) => {
            // console.log(res);
    ...
    const onDeleteComment = (id) => {
        ...
        return () => {
            ...
            axios.delete("https://api-movie-group-8.up.railway.app/api/comment/delete/" + id).then((res) => {
                console.log(res);
    ...
    useEffect(() => {
        const getComments = async () => {
            const response = springApi.getCommentsByMovie(props.id);
            response.then((res) => {
                console.log(res);
                setComments(res);
            });
